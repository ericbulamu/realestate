setwd("C:/Users/User/Desktop/realstate/data/HMS.F1990.LARS/1989")

delimiters <- c(28,8, 4,6,2,3,1, 2,1,4,9,1,4,9,1,4,9,1,4,9,1,4,9,1,1)
sum(delimiters)


dat <- read.fwf("HMD_FACDSB89.txt", delimiters,comment.char="")
...
write.csv2(dat, "HMS.F1989.csv", row.names = FALSE)